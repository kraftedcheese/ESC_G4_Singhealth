const non_fnb_audit = {
  ...
  const fnb_audit = {
    ...
    "Housekeeping and General Cleanliness": {
      issues: [
        ...
        "Adequate number of covered waste pedal bins are available and waste is properly managed and disposed, Waste bins are not over-filled, Waste is properly bagged before disposing it at the waste disposal area/ bin centre.",
    ...
    "Food Hygiene": {
      issues: [   
        ...
        "Dry goods (eg canned food and drinks) and other food items are stored neatly on shelves, off the floor and away from walls.",
        ...
        "Proper separation of cooked food/ ready-to-eat food, raw meat, seafood and vegetable to prevent cross-contamination; Different chopping boards, knives and other utensils are used for cooked/ ready-to-eat and raw food.",
        ...
        "All cooking ingredient (eg cooking oil, sauces) are properly covered in proper containers and properly labelled, indicating the content and date of expiry.",
        ...
        "Raw food and cooked food/ ready to serve food are clearly segregated; Cold and/ or hot holding units are clean and well maintained.",
        "Food preparation area is free of bird and animal (eg dog or cat).",
        ...
        "Hot food are held above 60°C; Food warmer’s temperature: > 60°C",
    ...
    "Healthier Choice in line with HPB’s Healthy Eating’s Initiative": {
      issues: [
        "Minimum number of healthier variety of food items per stall - Lease Term: 50% of food items.",
        "Label caloric count of healthier foods.",
        ...
        "Label caloric count of healthier beverages.",
  ...
  const safe_management_audit = {
    "Safe Management Measures for Front-of-house": {
      issues: [
        "SafeEntry has been implemented for dine-in customers.",
        "Temperature screening is conducted for customers of outlets that are located outside of institution’s temperature screening zone.",
        "Table and seating arrangement adheres to the one-metre spacing between tables or groups; Where tables/seats are fixed, tables/seats should be marked out, ensuring at least one-metre spacing.",
        "Queue is demarcated to ensure at least one-metre spacing between customers such as entrances and cashier counters (eg through floor markers).",
        "Staff to ensure customers maintain safe distance of one-metre when queuing and seated.",
        "Staff to ensure customers wear a mask at all times, unless eating or drinking.",
        "Hand sanitizers are placed at high touch areas (ie tray return, collection point, outlet entrance/exit).",
        "Outlet promotes use of cashless payment modes.",
      ],
      weightage: 61.54,
    },
    "Staff Hygiene & Safe Management Measures" : {
      issues: [
        "All staff to wear a mask at all times, unless eating or drinking.",
        "Mask worn by staff is in the correct manner (ie cover nose and mouth, no hanging of mask under the chin/neck).",
        "All staff to record their temperature daily.",
        "Staff to maintain safe distance of one-metre (where possible) and not congregate, including at common areas, and during break/meal times.",
        "Check with supervisor that all staff record SafeEntry check-in and check-out (Note: Supervisor is accountable for adherence)",
      ],
      weightage: 38.46,
    }
  };

  export { non_fnb_audit, fnb_audit, safe_management_audit };